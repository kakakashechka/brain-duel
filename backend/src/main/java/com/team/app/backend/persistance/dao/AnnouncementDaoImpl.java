...
public class AnnouncementDaoImpl implements AnnouncementDao {
    ...
    public List<Announcement> getAll() {
        return jdbcTemplate.query("select A.id,A.title,A.date,A.text,A.image,A.status_id,AS.name as status_name , A.user_id from announcement A INNER JOIN ann_status AS ON AS.id = A.status_id"
                ,userRowMapper);
    }
